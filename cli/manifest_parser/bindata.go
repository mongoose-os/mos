...
func dataMgos_deps_initCTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "data/mgos_deps_init.c.tmpl", size: 891, mode: os.FileMode(420), modTime: time.Unix(1587234708, 0)}
...
func dataRoot_manifestYml() (*asset, error) {
	...
	info := bindataFileInfo{name: "data/root_manifest.yml", size: 197, mode: os.FileMode(420), modTime: time.Unix(1587234708, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
